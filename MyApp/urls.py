...
urlpatterns = [
    ...
    path('workflow/quotations/<int:quote_id>/comments/add/', workflow_views.add_quotation_comment, name='workflow_add_quotation_comment'),
    path('workflow/quotations/<int:quote_id>/discussion/', workflow_views.quotation_discussion, name='workflow_quotation_discussion'),
    path('workflow/quotations/<int:quote_id>/submit-for-approval/', workflow_views.submit_quotation_for_approval, name='workflow_submit_for_approval'),
    path('workflow/notifications/', workflow_views.workflow_notifications, name='workflow_notifications'),
    ...
    path('workflow/quotations/<int:quote_id>/create-revision/', workflow_views.start_quotation_revision, name='workflow_start_quotation_revision'),
    ...
    path('projects/<int:id>/boq-planning/', views.BOQ_planning, name="BOQ_planning"),
    path('projects/<int:id>/boq-planning/import/', views.BOQ_import, name="BOQ_import"),
    path('projects/<int:id>/boq-planning/clear/', views.BOQ_clear, name="BOQ_clear"),
    path('projects/<int:id>/boq-planning/materials/', views.BOQ_save_materials, name="BOQ_save_materials"),
    path('projects/<int:id>/boq-planning/work-order/', views.BOQ_save_work_order, name="BOQ_save_work_order"),
    path('projects/<int:id>/boq-planning/work-order.pdf', views.BOQ_work_order_pdf, name="BOQ_work_order_pdf"),
    path('boq-planning/template.xlsx', views.BOQ_template, name="BOQ_template"),
